...
import { EventTasksSection } from '../components/event-tasks-section';
import { EventIncidentsSection } from '../components/event-incidents-section';
...
export function EventDetailPage() {
  ...
  return (
    ...
    >
      ...
      <EventTasksSection eventId={event.id} />

      <EventIncidentsSection eventId={event.id} />
